...
namespace Service.Service
{
    public class CoreAccessoryDetailService : ICoreAccessoryDetailService
    {
                                                    ...
                                                    IItemService _itemService, IItemTypeService _itemTypeService, IWarehouseItemService _warehouseItemService)
        {
            ...
            return this.CreateObject(coreAccessoryDetail, _coreIdentificationService, _coreIdentificationDetailService, _itemService, _itemTypeService, _warehouseItemService);
        }
                                                    ...
                                                    IItemService _itemService, IItemTypeService _itemTypeService, IWarehouseItemService _warehouseItemService)
        {
            ...
            return (coreAccessoryDetail = _validator.ValidCreateObject(coreAccessoryDetail, _coreIdentificationService, _coreIdentificationDetailService, _itemService, _itemTypeService, _warehouseItemService) ?
        ...
        public CoreAccessoryDetail UpdateObject(CoreAccessoryDetail coreAccessoryDetail, ICoreIdentificationService _coreIdentificationService, ICoreIdentificationDetailService _coreIdentificationDetailService,
                                                    IItemService _itemService, IItemTypeService _itemTypeService, IWarehouseItemService _warehouseItemService)
        {
            return (coreAccessoryDetail = _validator.ValidUpdateObject(coreAccessoryDetail, _coreIdentificationService, _coreIdentificationDetailService, _itemService, _itemTypeService, _warehouseItemService) ?
