            ...
            context["when blanket order details are cut"] = () =>
            {
                ...
                context["when blanket order details are all finished"] = () =>
                {
                    before = () =>
                    {
                        ...
                        d._blanketOrderDetailService.PrepareObject(d.blanketODContact1);
                        d._blanketOrderDetailService.ApplyTapeAdhesiveToObject(d.blanketODContact1);
                        d._blanketOrderDetailService.MountObject(d.blanketODContact1);
                        d._blanketOrderDetailService.HeatPressObject(d.blanketODContact1);
                        d._blanketOrderDetailService.PullOffTestObject(d.blanketODContact1);
                        d._blanketOrderDetailService.QCAndMarkObject(d.blanketODContact1);
                        ...
                        d._blanketOrderDetailService.PrepareObject(d.blanketODContact2);
                        d._blanketOrderDetailService.ApplyTapeAdhesiveToObject(d.blanketODContact2);
                        d._blanketOrderDetailService.MountObject(d.blanketODContact2);
                        d._blanketOrderDetailService.HeatPressObject(d.blanketODContact2);
                        d._blanketOrderDetailService.PullOffTestObject(d.blanketODContact2);
                        d._blanketOrderDetailService.QCAndMarkObject(d.blanketODContact2);
                        ...
                        d._blanketOrderDetailService.PrepareObject(d.blanketODContact3);
                        d._blanketOrderDetailService.ApplyTapeAdhesiveToObject(d.blanketODContact3);
                        d._blanketOrderDetailService.MountObject(d.blanketODContact3);
                        d._blanketOrderDetailService.HeatPressObject(d.blanketODContact3);
                        d._blanketOrderDetailService.PullOffTestObject(d.blanketODContact3);
                        d._blanketOrderDetailService.QCAndMarkObject(d.blanketODContact3);
                        ...
                        d._blanketOrderDetailService.PrepareObject(d.blanketODContact4);
                        d._blanketOrderDetailService.ApplyTapeAdhesiveToObject(d.blanketODContact4);
                        d._blanketOrderDetailService.MountObject(d.blanketODContact4);
                        d._blanketOrderDetailService.HeatPressObject(d.blanketODContact4);
                        d._blanketOrderDetailService.PullOffTestObject(d.blanketODContact4);
                        d._blanketOrderDetailService.QCAndMarkObject(d.blanketODContact4);
                    };
                    ...
                    it["validates_finishblanketorder"] = () =>
                    {
                        ...
                        d._blanketOrderDetailService.FinishObject(d.blanketODContact1, DateTime.Today, d._blanketOrderService, d._stockMutationService, d._blanketService, d._itemService, d._warehouseItemService);
                        d._blanketOrderDetailService.FinishObject(d.blanketODContact2, DateTime.Today, d._blanketOrderService, d._stockMutationService, d._blanketService, d._itemService, d._warehouseItemService);
                        d._blanketOrderDetailService.FinishObject(d.blanketODContact3, DateTime.Today, d._blanketOrderService, d._stockMutationService, d._blanketService, d._itemService, d._warehouseItemService);
                        d._blanketOrderDetailService.RejectObject(d.blanketODContact4, DateTime.Today, d._blanketOrderService, d._stockMutationService, d._blanketService, d._itemService, d._warehouseItemService);
