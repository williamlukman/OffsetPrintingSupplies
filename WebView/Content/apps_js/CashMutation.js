$(document).ready(function () {
    ...
    $("#list").jqGrid({
        ...
        datatype: "json",
        colNames: ['ID', 'CashBank Id', 'Name',
                   'Amount', 'Source', 'Id', 'Created At', 'Mutation Date'],
        colModel: [
    			  { name: 'id', index: 'id', width: 35, align: "center" },
    			  { name: 'cashbankid', index: 'cashbankid', width: 35, align: "center", hidden: true},
				  { name: 'name', index: 'CashBank', width: 120 },
                  { name: 'amount', index: 'RealAmount', width: 150, align: 'right', formatter: 'integer', formatoptions: { thousandsSeparator: ",", defaultValue: '0' } },
				  { name: 'source', index: 'SourceDocumentType', width: 120, align: 'right' },
				  { name: 'sourceid', index: 'SourceDocumentId', width: 55 },
