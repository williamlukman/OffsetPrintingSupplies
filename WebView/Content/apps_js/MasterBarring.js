$(document).ready(function () {
    ...
    $("#list").jqGrid({
        ...
        colNames: ['ID', 'Name', 'Category', 'ItemType Id','ItemType Name','UoM Id', 'UoM',
                   ...
                   'Is Bar Required', 'Has LeftBar', 'Has RightBar',
        ...
        colModel: [
                  ...
                  { name: 'isbarrequired', index: 'isbarrequired', width: 130 },
                  { name: 'hasleftbar', index: 'hasleftbar', width: 130 },
                  { name: 'hasrightbar', index: 'hasrightbar', width: 130 },
