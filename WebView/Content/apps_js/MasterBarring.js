$(document).ready(function () {
    ...
    $("#list").jqGrid({
        ...
        colNames: ['ID', 'Sku', 'Name', 'Roll No', 'Quantity', 'UoM',
                   'AC', 'AR', 'Thickness', 'KS', 'Category',
                   'ItemType', 'Machine', 'Blanket', 
                   'LeftBar', 'RightBar', 'Contact',
        ...
        colModel: [
                  ...
                  { name: 'ks', index: 'ks', width: 30, formatter: 'integer', align: 'right', formatoptions: { thousandsSeparator: ",", defaultValue: '0' } },
                  { name: 'category', index: 'category', width: 60 },
                  { name: 'itemtypename', index: 'itemtypename', width: 60 },
                  { name: 'machinename', index: 'machinename', width: 110 },
                  { name: 'blanketname', index: 'blanketname', width: 90 },
