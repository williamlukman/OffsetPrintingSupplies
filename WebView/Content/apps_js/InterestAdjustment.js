$(document).ready(function () {
    ...
    function ReloadGrid() {
        $("#list").setGridParam({ url: base_url + 'InterestAdjustment/GetList', postData: { filters: null }, page: 'first' }).trigger("reloadGrid");
    }
    ...
    $('#btn_print').click(function () {
        ...
        if (id) {
            $.ajax({
                dataType: "json",
                url: base_url + "InterestAdjustment/GetInfo?Id=" + id,
                success: function (result) {
                    if (result.Id == null) {
                        ...
                        window.open(base_url + "Report/PrintoutInterestAdjustment?Id=" + id);
                    }
                }
            });
        }
    ...
    $('#btn_add_new').click(function () {
        ClearData();
        clearForm('#frm');
        $('#InterestDate').datebox('setValue', $.datepicker.formatDate('mm/dd/yy', new Date()));
    ...
    $('#btn_unconfirm').click(function () {
        ...
        if (id) {
            ...
            $.messager.confirm('Confirm', 'Are you sure you want to unconfirm record?', function (r) {
                if (r) {
                    $.ajax({
                        url: base_url + "InterestAdjustment/Unconfirm",
                        type: "POST",
    ...
    $('#confirm_btn_submit').click(function () {
        ...
        $.ajax({
            url: base_url + "InterestAdjustment/Confirm",
            type: "POST",
            contentType: "application/json",
            data: JSON.stringify({
    ...
    $('#delete_confirm_btn_submit').click(function () {
        ...
        $.ajax({
            url: base_url + "InterestAdjustment/Delete",
            type: "POST",
            contentType: "application/json",
            data: JSON.stringify({
    ...
    $("#form_btn_save").click(function () {
        ...
        if (id != undefined && id != '' && !isNaN(id) && id > 0) {
            submitURL = base_url + 'InterestAdjustment/Update';
        }
            // Insert
        else {
