$(document).ready(function () {
    ...
    function ReloadGrid() {
        $("#list").setGridParam({ url: base_url + 'Employee/GetList', postData: { filters: null }, page: 'first' }).trigger("reloadGrid");
    }
    ...
    $("#form_btn_save").click(function () {
        ...
        $.ajax({
            ...
            url: submitURL,
            data: JSON.stringify({
                Id: id, Name: $("#Name").val(), Address: $("#Address").val(),  Description: $("#Description").val(),
                ContactNo: $("#ContactNo").val(), Email: $("#Email").val()
            }),
            async: false,
            cache: false,
            timeout: 30000,
