$(document).ready(function () {
    ...
    function ReloadGrid() {
        $("#list").setGridParam({ url: base_url + 'ExchangeRate/GetList', postData: { filters: null }, page: 'first' }).trigger("reloadGrid");
    }
    ...
    $("#list").jqGrid({
        ...
        datatype: "json",
        colNames: ['ID', 'Currency', 'Date', 'Rate','Created At', 'Updated At'],
        colModel: [
    			  { name: 'id', index: 'id', width: 60, align: "center" },
				  { name: 'currency', index: 'currency', width: 120 },
                  ...
                  { name: 'rate', index: 'rate', width: 100, align: "right", formatter: 'currency', formatoptions: { decimalSeparator: ".", thousandsSeparator: ",", decimalPlaces: 2, prefix: "", suffix: "", defaultValue: '0.00' } },
    ...
    $('#btn_add_new').click(function () {
        ...
        $('#ExRateDate').datebox('setValue', $.datepicker.formatDate('mm/dd/yy', new Date()));
    ...
    $("#form_btn_save").click(function () {
        ...
        $.ajax({
            ...
            url: submitURL,
            data: JSON.stringify({
                Id: id, CurrencyId: bank, Rate: $("#Rate").numberbox('getValue'), ExRateDate: $('#ExRateDate').datebox('getValue')
            }),
            async: false,
            cache: false,
            timeout: 30000,
