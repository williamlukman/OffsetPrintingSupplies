$(document).ready(function () {
    ...
    function ReloadGrid() {
        $("#list").setGridParam({ url: base_url + 'ValidCombIncomeStatement/GetList', postData: { filters: null }, page: 'first' }).trigger("reloadGrid");
    }

    function ReloadFilteredGrid(ClosingId) {
        $("#list").setGridParam({ url: base_url + 'ValidCombIncomeStatement/GetListByDate?', postData: { ClosingId: ClosingId }, page: 'first' }).trigger("reloadGrid");
    }
    ...
    $("#list").jqGrid({
        url: base_url + 'ValidCombIncomeStatement/GetList',
        datatype: "json",
    ...
    $('#btn_print').click(function () {
        window.open(base_url + 'Print_Forms/PrintValidCombIncomeStatement.aspx');
    });
