$(document).ready(function () {
    ...
    function ReloadGrid() {
        $("#list").setGridParam({ url: base_url + 'PurchaseAllowance/GetList', postData: { filters: null }, page: 'first' }).trigger("reloadGrid");
    }

    function ReloadGridDetail() {
        $("#listdetail").setGridParam({ url: base_url + 'PurchaseAllowance/GetListDetail?Id=' + $("#id").val(), postData: { filters: null }, page: 'first' }).trigger("reloadGrid");
    }
    ...
    //GRID +++++++++++++++
    $("#list").jqGrid({
        url: base_url + 'PurchaseAllowance/GetList',
        datatype: "json",
    ...
    $('#btn_add_detail').click(function () {
        ...
        if (id) {
            $.ajax({
                dataType: "json",
                url: base_url + "PurchaseAllowance/GetInfo?Id=" + id,
                success: function (result) {
                    if (result.Id == null) {
                        ...
                        if (JSON.stringify(result.Errors) != '{}') {
                            ...
                            $('#PaymentDate').datebox('setValue', dateEnt(result.AllowanceAllocationDate));
                            $('#PaymentDate2').val(dateEnt(result.AllowanceAllocationDate));
    ...
    $('#btn_unconfirm').click(function () {
        ...
        if (id) {
            ...
            $.messager.confirm('Confirm', 'Are you sure you want to unconfirm record?', function (r) {
                if (r) {
                    $.ajax({
                        url: base_url + "PurchaseAllowance/Unconfirm",
                        type: "POST",
    ...
    $('#confirm_btn_submit').click(function () {
        ClearErrorMessage();
        $.ajax({
            url: base_url + "PurchaseAllowance/Confirm",
            type: "POST",
            contentType: "application/json",
            data: JSON.stringify({
    ...
    $('#btn_unreconcile').click(function () {
        ...
        if (id) {
            ...
            $.messager.confirm('Confirm', 'Are you sure you want to unreconcile record?', function (r) {
                if (r) {
                    $.ajax({
                        url: base_url + "PurchaseAllowance/UnReconcile",
                        type: "POST",
                        contentType: "application/json",
                        data: JSON.stringify({
                            Id: id,
    ...
    $('#reconcile_btn_submit').click(function () {
        ClearErrorMessage();
        $.ajax({
            url: base_url + "PurchaseAllowance/Reconcile",
            type: "POST",
            contentType: "application/json",
            data: JSON.stringify({
    ...
    $('#delete_confirm_btn_submit').click(function () {
        ...
        $.ajax({
            url: base_url + "PurchaseAllowance/Delete",
            type: "POST",
            contentType: "application/json",
            data: JSON.stringify({
    ...
    $("#form_btn_save").click(function () {
        ...
        if (id != undefined && id != '' && !isNaN(id) && id > 0) {
            submitURL = base_url + 'PurchaseAllowance/Update';
        }
            // Insert
        else {
            submitURL = base_url + 'PurchaseAllowance/Insert';
        }
        ...
        $.ajax({
            ...
            data: JSON.stringify({
                ...
                AllowanceAllocationDate: $('#PaymentDate').datebox('getValue'), DueDate: $('#DueDate').datebox('getValue'),
            }),
            async: false,
            cache: false,
            timeout: 30000,
    ...
    $('#btn_edit_detail').click(function () {
        ...
        if (id) {
            $.ajax({
                dataType: "json",
                url: base_url + "PurchaseAllowance/GetInfoDetail?Id=" + id,
                success: function (result) {
                    if (result.Id == null) {
                        $.messager.alert('Information', 'Data Not Found...!!', 'info');
                    }
                        ...
                        if (JSON.stringify(result.Errors) != '{}') {
                            ...
                            $('#PurchaseAllowanceDetailId').val(result.PurchaseAllowanceDetailId);
                            $('#item_div').dialog('open');
                        }
                    }
                }
    ...
    $('#btn_del_detail').click(function () {
        ...
        if (id) {
            ...
            $.messager.confirm('Confirm', 'Are you sure you want to delete record?', function (r) {
                if (r) {
                    $.ajax({
                        url: base_url + "PurchaseAllowance/DeleteDetail",
                        type: "POST",
                        contentType: "application/json",
                        data: JSON.stringify({
                            Id: id,
    ...
    $("#item_btn_submit").click(function () {
        ...
        // Update
        if (id != undefined && id != '' && !isNaN(id) && id > 0) {
            submitURL = base_url + 'PurchaseAllowance/UpdateDetail';
        }
            // Insert
        else {
            submitURL = base_url + 'PurchaseAllowance/InsertDetail';
        }
        ...
        $.ajax({
            ...
            url: submitURL,
            data: JSON.stringify({
                Id: id, PurchaseAllowanceId: $("#id").val(), PayableId: $("#PayableId").val(), Description: $("#Description").val(),
    ...
    $('#btnPayable').click(function () {
        var lookUpURL = base_url + 'PurchaseAllowance/GetListPayable';
