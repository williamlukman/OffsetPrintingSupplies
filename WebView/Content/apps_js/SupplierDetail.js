$(document).ready(function () {
    ...
    function ReloadGrid() {
        $("#list").setGridParam({ url: base_url + 'SupplierDetail/GetList', postData: { filters: null }, page: 'first' }).trigger("reloadGrid");
    }
    ...
    //GRID +++++++++++++++
    $("#list").jqGrid({
        url: base_url + 'SupplierDetail/GetList',
        datatype: "json",
    ...
    $('#btn_edit').click(function () {
        ...
        if (id) {
            ...
            $.ajax({
                dataType: "json",
                url: base_url + "SupplierDetail/GetInfo?Id=" + id,
    ...
    $('#delete_confirm_btn_submit').click(function () {
        ...
        $.ajax({
            url: base_url + "SupplierDetail/Delete",
            type: "POST",
    ...
    $("#form_btn_save").click(function () {
        ...
        if (id != undefined && id != '' && !isNaN(id) && id > 0) {
            submitURL = base_url + 'SupplierDetail/Update';
        }
        // Insert
        else {
            submitURL = base_url + 'SupplierDetail/Insert';
        }
