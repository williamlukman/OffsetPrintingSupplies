$(document).ready(function () {
    ...
    $('#btn_print').click(function () {
        ...
        //}
        window.open(base_url + 'Report/ReportSalesPersonnelYearly?startDate=' + $('#StartDate').datebox('getValue') + '&endDate=' + $('#EndDate').datebox('getValue') + '&EmployeeId=' + $('#EmployeeId').val()); //JSON.stringify(idarray)
    });
