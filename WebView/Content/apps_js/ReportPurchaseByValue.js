$(document).ready(function () {
    ...
    $('#btn_print').click(function () {
        ...
        //}
        window.open(base_url + 'Report/ReportPurchaseByValue?startDate=' + $('#StartDate').datebox('getValue') + '&endDate=' + $('#EndDate').datebox('getValue') + '&ContactId=' + $('#ContactId').val()); //JSON.stringify(idarray)
    });
