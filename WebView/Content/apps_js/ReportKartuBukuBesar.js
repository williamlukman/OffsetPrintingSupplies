$(document).ready(function () {
    ...
    $('#btn_print').click(function () {
        ...
        //}
        window.open(base_url + "FinanceReport/ReportKartuBukuBesar?AccountId=" + $('#AccountId').val() + '&startDate=' + $('#StartDate').datebox('getValue') + '&endDate=' + $('#EndDate').datebox('getValue')); //JSON.stringify(idarray)
    });
