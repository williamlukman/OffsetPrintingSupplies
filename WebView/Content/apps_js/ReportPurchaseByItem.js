$(document).ready(function () {
    ...
    $('#btn_print').click(function () {
        ...
        //}
        window.open(base_url + 'Report/ReportPurchaseByItem?startDate=' + $('#StartDate').datebox('getValue') + '&endDate=' + $('#EndDate').datebox('getValue') + '&ItemId=' + $('#ItemId').val()); //JSON.stringify(idarray)
    });
