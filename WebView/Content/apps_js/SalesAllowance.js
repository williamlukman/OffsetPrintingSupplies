$(document).ready(function () {
    ...
    function ReloadGrid() {
        $("#list").setGridParam({ url: base_url + 'SalesAllowance/GetList', postData: { filters: null }, page: 'first' }).trigger("reloadGrid");
    }

    function ReloadGridDetail() {
        $("#listdetail").setGridParam({ url: base_url + 'SalesAllowance/GetListDetail?Id=' + $("#id").val(), postData: { filters: null }, page: 'first' }).trigger("reloadGrid");
    }
    ...
    //GRID +++++++++++++++
    $("#list").jqGrid({
        url: base_url + 'SalesAllowance/GetList',
        datatype: "json",
    ...
    $('#btn_add_detail').click(function () {
        ...
        if (id) {
            $.ajax({
                dataType: "json",
                url: base_url + "SalesAllowance/GetInfo?Id=" + id,
                success: function (result) {
                    if (result.Id == null) {
                        ...
                        if (JSON.stringify(result.Errors) != '{}') {
                            ...
                            $('#ReceiptDate').datebox('setValue', dateEnt(result.AllowanceAllocationDate));
                            $('#ReceiptDate2').val(dateEnt(result.AllowanceAllocationDate));
    ...
    $('#btn_unconfirm').click(function () {
        ...
        if (id) {
            ...
            $.messager.confirm('Confirm', 'Are you sure you want to unconfirm record?', function (r) {
                if (r) {
                    $.ajax({
                        url: base_url + "SalesAllowance/Unconfirm",
                        type: "POST",
    ...
    $('#btn_unreconcile').click(function () {
        ...
        if (id) {
            ...
            $.messager.confirm('Confirm', 'Are you sure you want to unreconcile record?', function (r) {
                if (r) {
                    $.ajax({
                        url: base_url + "SalesAllowance/UnReconcile",
                        type: "POST",
                        contentType: "application/json",
                        data: JSON.stringify({
                            Id: id,
    ...
    $('#reconcile_btn_submit').click(function () {
        ClearErrorMessage();
        $.ajax({
            url: base_url + "SalesAllowance/Reconcile",
            type: "POST",
            contentType: "application/json",
            data: JSON.stringify({
    ...
    $('#delete_confirm_btn_submit').click(function () {
        ...
        $.ajax({
            url: base_url + "SalesAllowance/Delete",
            type: "POST",
            contentType: "application/json",
            data: JSON.stringify({
    ...
    $("#form_btn_save").click(function () {
        ...
        if (id != undefined && id != '' && !isNaN(id) && id > 0) {
            submitURL = base_url + 'SalesAllowance/Update';
        }
            // Insert
        else {
            submitURL = base_url + 'SalesAllowance/Insert';
        }
        ...
        $.ajax({
            ...
            data: JSON.stringify({
                ...
                AllowanceAllocationDate: $('#ReceiptDate').datebox('getValue'), DueDate: $('#DueDate').datebox('getValue'),
            }),
            async: false,
            cache: false,
            timeout: 30000,
    ...
    $('#btn_edit_detail').click(function () {
        ...
        if (id) {
            $.ajax({
                dataType: "json",
                url: base_url + "SalesAllowance/GetInfoDetail?Id=" + id,
                success: function (result) {
                    if (result.Id == null) {
                        $.messager.alert('Information', 'Data Not Found...!!', 'info');
                    }
                        ...
                        if (JSON.stringify(result.Errors) != '{}') {
                            ...
                            $('#SalesAllowanceDetailId').val(result.SalesAllowanceDetailId);
                            $('#item_div').dialog('open');
                        }
                    }
                }
    ...
    $('#btn_del_detail').click(function () {
        ...
        if (id) {
            ...
            $.messager.confirm('Confirm', 'Are you sure you want to delete record?', function (r) {
                if (r) {
                    $.ajax({
                        url: base_url + "SalesAllowance/DeleteDetail",
                        type: "POST",
                        contentType: "application/json",
                        data: JSON.stringify({
                            Id: id,
    ...
    $("#item_btn_submit").click(function () {
        ...
        // Update
        if (id != undefined && id != '' && !isNaN(id) && id > 0) {
            submitURL = base_url + 'SalesAllowance/UpdateDetail';
        }
            // Insert
        else {
            submitURL = base_url + 'SalesAllowance/InsertDetail';
        }
        ...
        $.ajax({
            ...
            url: submitURL,
            data: JSON.stringify({
                Id: id, SalesAllowanceId: $("#id").val(), ReceivableId: $("#ReceivableId").val(), Description: $("#Description").val(),
    ...
    $('#btnReceivable').click(function () {
        var lookUpURL = base_url + 'SalesAllowance/GetListReceivable';
