...
namespace WebView.Controllers
{
    ...
    {
        private readonly static log4net.ILog LOG = log4net.LogManager.GetLogger("ContactDetailController");
        ...
        public dynamic GetList(string _search, long nd, int rows, int? page, string sidx, string sord, string filters = "")
        {
            ...
            // Get Data
            var q = _contactDetailService.GetQueryable().Where(x => !x.IsDeleted && x.Contact.ContactType == "Customer");
