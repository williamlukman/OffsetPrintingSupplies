    ...
    public class MstBlanketController : Controller
    {
        ...
        public dynamic GetInfo(int Id)
        {
            ...
            return Json(new
            {
                ...
                model.AdhesiveId,
                Adhesive = model.AdhesiveId.GetValueOrDefault() == null ? "" : _itemService.GetObjectById(model.AdhesiveId.GetValueOrDefault()).Name,
                model.Adhesive2Id,
                Adhesive2 = model.Adhesive2Id.GetValueOrDefault() == null ? "" : _itemService.GetObjectById(model.Adhesive2Id.GetValueOrDefault()).Name,
