...
namespace WebView.Controllers
{
    ...
    {
        private readonly static log4net.ILog LOG = log4net.LogManager.GetLogger("ContactGroupController");
        ...
        public dynamic GetList(string _search, long nd, int rows, int? page, string sidx, string sord, string filters = "")
        {
            ...
            // Get Data
            var q = _contactGroupService.GetQueryable().Where(x => !x.IsDeleted).Include("Account");
        ...
        public dynamic Delete(ContactGroup model)
        {
            ...
            {
                var data = _contactGroupService.GetObjectById(model.Id);
                model = _contactGroupService.SoftDeleteObject(data, _contactService);
            }
            catch (Exception ex)
            {
