...
{
    public class GeneralLedgerSaldoController : Controller
    {
        private readonly static log4net.ILog LOG = log4net.LogManager.GetLogger("GeneralLedgerSaldoController");
        ...
        public GeneralLedgerSaldoController()
        {
