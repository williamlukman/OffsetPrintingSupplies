...
{
    public class ValidCombIncomeStatementController : Controller
    {
        private readonly static log4net.ILog LOG = log4net.LogManager.GetLogger("ValidCombIncomeStatementController");
        ...
        public ValidCombIncomeStatementController()
        {
        ...
        {
            if (!AuthenticationModel.IsAllowed("View", Core.Constants.Constant.MenuName.ValidCombIncomeStatement, Core.Constants.Constant.MenuGroupName.Report))
            {
        ...
        public dynamic GetList(string _search, long nd, int rows, int? page, string sidx, string sord, string filters = "")
        {
            ...
            // Get Data
            var q = _validCombIncomeStatementService.GetQueryable().Include("Account").Include("Closing").Where(x => x.Account.IsLeaf);
        ...
        public dynamic GetListByDate(string _search, long nd, int rows, int? page, string sidx, string sord, int? ClosingId, string filters = "")
        {
            ...
            // Get Data
            var q = _validCombIncomeStatementService.GetQueryable().Include("Account").Include("Closing").Where(x => x.Closing.IsClosed && x.Account.IsLeaf);
