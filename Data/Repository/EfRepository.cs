...
namespace Data.Repository
{
    public class EfRepository<T> : IRepository<T>
         where T : class
    {
        protected OffsetPrintingSuppliesEntities Context;
        ...
        public EfRepository()
        {
            Context = new OffsetPrintingSuppliesEntities();
        }
        ...
        public OffsetPrintingSuppliesEntities GetContext()
        {
            return new OffsetPrintingSuppliesEntities();
        }
