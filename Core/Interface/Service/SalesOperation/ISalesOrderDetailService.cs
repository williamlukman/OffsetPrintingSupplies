...
namespace Core.Interface.Service
{
    public interface ISalesOrderDetailService
    {
        ...
        SalesOrderDetail CreateObject(SalesOrderDetail salesOrderDetail, ISalesOrderService _salesOrderService,
                                      IItemService _itemService, ISalesQuotationDetailService _salesQuotationDetailService);
        SalesOrderDetail CreateObject(int salesOrderId, int itemId, int quantity, decimal Price, ISalesOrderService _salesOrderService,
                                      IItemService _itemService, ISalesQuotationDetailService _salesQuotationDetailService);
        SalesOrderDetail UpdateObject(SalesOrderDetail salesOrderDetail, ISalesOrderService _salesOrderService,
                                      IItemService _itemService, ISalesQuotationDetailService _salesQuotationDetailService);
