...
namespace Core.Interface.Validation
{
    public interface IReceiptVoucherValidator
    {
        ...
        ReceiptVoucher VNotIsGBCH(ReceiptVoucher receiptVoucher);
        ...
        ReceiptVoucher VTotalAmountEqualDetailsAmount(ReceiptVoucher receiptVoucher, IReceiptVoucherDetailService _receiptVoucherDetailService);
        ...
        ReceiptVoucher VCashBankIsGreaterThanOrEqualReceiptVoucherDetails(ReceiptVoucher receiptVoucher, IReceiptVoucherDetailService _receiptVoucherDetailService,
        ...
        ReceiptVoucher VUnreconcileObject(ReceiptVoucher receiptVoucher, IReceiptVoucherDetailService _receiptVoucherDetailService, ICashBankService _cashBankService, IClosingService _closingService);
        ...
        bool ValidConfirmObject(ReceiptVoucher receiptVoucher, IReceiptVoucherService _receiptVoucherService,
                                IReceiptVoucherDetailService _receiptVoucherDetailService, ICashBankService _cashBankService,
                                IReceivableService _receivableService, IClosingService _closingService);
        bool ValidUnconfirmObject(ReceiptVoucher receiptVoucher, IReceiptVoucherDetailService _receiptVoucherDetailService, ICashBankService _cashBankService, IClosingService _closingService);
        bool ValidReconcileObject(ReceiptVoucher receiptVoucher, IClosingService _closingService);
        bool ValidUnreconcileObject(ReceiptVoucher receiptVoucher, IReceiptVoucherDetailService _receiptVoucherDetailService, ICashBankService _cashBankService, IClosingService _closingService);
