...
namespace Core.Interface.Validation
{
    ...
    {
        BlendingRecipe VCreateObject(BlendingRecipe blendingRecipe, IBlendingRecipeService _blendingRecipeService, IItemService _itemService);
        BlendingRecipe VUpdateObject(BlendingRecipe blendingRecipe, IBlendingRecipeService _blendingRecipeService, IItemService _itemService);
        ...
        bool ValidCreateObject(BlendingRecipe blendingRecipe, IBlendingRecipeService _blendingRecipeService, IItemService _itemService);
        bool ValidUpdateObject(BlendingRecipe blendingRecipe, IBlendingRecipeService _blendingRecipeService, IItemService _itemService);
