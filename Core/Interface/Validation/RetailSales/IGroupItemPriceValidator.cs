...
namespace Core.Interface.Validation
{
    public interface IGroupItemPriceValidator
    {
        ...
        GroupItemPrice VIsValidGroup(GroupItemPrice groupItemPrice, IGroupService _groupService);
        GroupItemPrice VIsValidItem(GroupItemPrice groupItemPrice, IItemService _itemService);

        GroupItemPrice VCreateObject(GroupItemPrice groupItemPrice, IGroupItemPriceService _groupItemPriceService, IGroupService _groupService, IItemService _itemService);
        ...
        bool ValidCreateObject(GroupItemPrice groupItemPrice, IGroupItemPriceService _groupItemPriceService, IGroupService _groupService, IItemService _itemService);
