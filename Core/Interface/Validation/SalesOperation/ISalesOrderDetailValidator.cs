...
namespace Core.Interface.Validation
{
    public interface ISalesOrderDetailValidator
    {
        ...
        SalesOrderDetail VHasSalesQuotationDetail(SalesOrderDetail salesOrderDetail, ISalesOrderService _salesOrderService,
                                                  ISalesQuotationDetailService _salesQuotationDetailService);
        SalesOrderDetail VHasSameSalesQuotation(SalesOrderDetail salesOrderDetail, ISalesOrderService _salesOrderService,
                                                ISalesQuotationDetailService _salesQuotationDetailService);
        ...
        SalesOrderDetail VCreateObject(SalesOrderDetail salesOrderDetail, ISalesOrderDetailService _salesOrderDetailService, ISalesOrderService _salesOrderService,
                                       IItemService _itemService, ISalesQuotationDetailService _salesQuotationDetailService);
        SalesOrderDetail VUpdateObject(SalesOrderDetail salesOrderDetail, ISalesOrderDetailService _salesOrderDetailService, ISalesOrderService _salesOrderService,
                                       IItemService _itemService, ISalesQuotationDetailService _salesQuotationDetailService);
        ...
        bool ValidCreateObject(SalesOrderDetail salesOrderDetail, ISalesOrderDetailService _salesOrderDetailService, ISalesOrderService _salesOrderService,
                               IItemService _itemService, ISalesQuotationDetailService _salesQuotationDetailService);
        bool ValidUpdateObject(SalesOrderDetail salesOrderDetail, ISalesOrderDetailService _salesOrderDetailService, ISalesOrderService _salesOrderService,
                               IItemService _itemService, ISalesQuotationDetailService _salesQuotationDetailService);
